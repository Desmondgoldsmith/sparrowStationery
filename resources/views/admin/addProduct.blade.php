            ...
            <div class="card-body">
             ...
             @endif
              ...
              <div class="col-12">
               ...
               {{Form::text('productName','',['class'=>'form-control','placeholder'=>'input category name','id'=>'productName'])}} 
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
               {{Form::label('', 'Product Price', ['for'=>'productPrice','class'=>'form-lable'])}} 
               {{Form::text('productPrice','', ['class'=>'form-control','placeholder'=>'eg: GHc 4.00','name'=>'productPrice', 'id'=>'productPrice'])}}
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">

...
<div class="container">
    <div class="card mb-3">
        <div class="card-body">
          <div class="pt-4 pb-2">
            <h5 class="card-title text-center pb-0 fs-4">Add Slider</h5>
          </div>
         ...
         @endif
          ...
          <div class="col-12">
           ...
           {{Form::text('sliderText','',['class'=>'form-control','placeholder'=>'input slider text','id'=>'sliderText','style'=>'color:white'])}} 
            </div>
          </div>
